...
##### MainPage Header
The biggest change in MainPage Header is the Logo is moved to MainPage Sidebar and the MainPage Header has now color variations, here are all changes:
...
##### MainPage Sidebar
Like above the biggest change is the MainPage Sidebar contains now the Logo and the sidebar has now color variations, here all changes:

1. MainPage Sidebar Color
